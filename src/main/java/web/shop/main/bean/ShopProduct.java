...
public class ShopProduct {
	...
	public String toString() {
		return "ShopProduct [shopProductId=" + shopProductId + ", shopProductName=" + shopProductName
				...
				+ shopName + ", firmNo=" + firmNo + ", shopProductImage=" + Arrays.toString(shopProductImage) + "]";
	}
